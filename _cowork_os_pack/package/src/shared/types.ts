...
export interface Task {
  ...
  requiresApproval?: boolean; // Whether some steps in this task require user approval
}
...
export const IPC_CHANNELS = {
  ...
  VOICE_TEST_LOCAL_TTS: "voice:testLocalTts",
  VOICE_TEST_LOCAL_STT: "voice:testLocalStt",
...
> = {
  ...
  nemoclaw: { name: "NemoClaw", icon: "\u{1F517}", color: "#64748b" },
  jan: { name: "Jan", icon: "\u{1F517}", color: "#64748b" },
  "lm-studio": { name: "LM Studio", icon: "\u{1F517}", color: "#64748b" },
};
...
export interface AddChannelRequest {
  ...
  emailHistoricalSyncStartDate?: string;
  emailHistoricalSyncBatchSize?: number;
...
export interface VoiceSettings {
  ...
  /** Local Piper executable or shortcut path for TTS */
  localTtsCommand?: string;

  /** Optional additional arguments for local Piper TTS */
  localTtsArgs?: string;

  /** Local Whisper executable or shortcut path for STT */
  localSttCommand?: string;

  /** Optional additional arguments for local Whisper STT */
  localSttArgs?: string;
}
