...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  testLocalTtsConnection: () => ipcRenderer.invoke(IPC_CHANNELS.VOICE_TEST_LOCAL_TTS),
  testLocalSttConnection: () => ipcRenderer.invoke(IPC_CHANNELS.VOICE_TEST_LOCAL_STT),
...
export interface ElectronAPI {
  ...
  testLocalTtsConnection: () => Promise<{ success: boolean; error?: string; details?: string }>;
  testLocalSttConnection: () => Promise<{ success: boolean; error?: string; details?: string }>;
