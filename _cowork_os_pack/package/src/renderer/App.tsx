          ...
          >
            {!leftSidebarCollapsed && (
              <Sidebar
                ...
                isSuppliersActive={currentView === "suppliers"}
                ...
                onOpenSettings={(tab) => {
                  if (tab) setSettingsTab((tab as typeof settingsTab) || "appearance");
                  setCurrentView("settings");
                }}
            ...
            {currentView === "home" ? (
              ...
              <div className="dp-panel">
                <div className="dp-header">
                  <div>
                    <span className="dp-support-eyebrow">Suppliers &amp; Providers</span>
                    <h2>Supplier dashboard</h2>
                  </div>
                </div>
                <div className="dp-placeholder">
                  Open email threads and invoices in Safe Mode, prepare orders locally, and approve manually at checkout.
                </div>
              </div>
            ) : (
              <MainContent
